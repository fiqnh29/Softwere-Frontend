                                ...
                                {val.Tier.map((val) => {
                                    return (
                                        <div className='Pricing-Li'>
                                            <IoMdCheckmarkCircleOutline color='green'/>&nbsp;{val}
                                        </div>
                                    )
                                })}
                        </div>
            ...
            <div className='Home-Container'>
                <section id='SideNav' className='Sidenav-Container'>
                    <div style={{padding : '20px', textAlign:'right'}}>
                        <button className='SideNav-Btn-Close' onClick={this.closeSideNav}>
                            <RiCloseLine size={45}/>
                        </button>
                    </div>
                    <div className='Sidenav-Link'>
                        <li className='SideNav-Logo'>
                            <a onClick={this.closeSideNav} href='#Home'>
                                <span style={{color:'black'}}>SOFT</span>
                                <span style={{color:'#964CF7'}}>HOUSE</span>
                            </a>
                        </li>
